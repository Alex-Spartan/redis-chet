...
import { getMessage } from "@/app/actions/message.actions";
      ...
      <AnimatePresence>
            ...
            <motion.div
              ...
              transition={{
                ...
                layout: {
                  type: "inertia",
                  bounce: 0.4,
                  duration: (messages as Message[]).indexOf(message) * 0.05 + 0.2,
                },
              }}
              style={{
                originX: 0.5,
                ...
                {message.senderId === currentUser?.id && (
                  <Avatar>
                    <AvatarImage
                      ...
                      alt={currentUser?.given_name || "User"}
                      className="border-2 border-white rounded-full"
                    />
                  </Avatar>
                )}
        ...
        {isMessageLoading && (
          <>
            ...
            <MessageSkeleton key="skeleton-4" />
          </>
        )}
      </AnimatePresence>
    </div>
